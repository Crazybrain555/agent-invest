...
6. **Benchmark before designing.** Plan proposals and optimizations start from a survey of comparable
   open-source implementations; fold in what they do better and surface gaps unprompted.
