...
def _select_unit_evidence(
    *,
    ...
    sql = (
        ...
        "d.provider, d.provider_document_id, d.security_code, d.raw_file_hash, "
        "r.artifact_owner_processing_run_id, "
        "r.artifact_hash AS producer_artifact_hash, "
        "r.input_raw_file_hash AS producer_input_raw_file_hash, "
        ...
        "owner.artifact_hash, "
        "owner.input_raw_file_hash AS artifact_owner_input_raw_file_hash "
        f"FROM {PUBLIC_SCHEMA}.document_units_v1 u "
